...
_P.S. 文章基本摘录自冴羽大佬的博客，因为大佬叙述的整体框架太棒了，逻辑梳理得很完美，对于理解 JS 作用域闭包很有帮助，文笔也很赞，本文主要用于个人整理学习使用_
...
Function.prototype.myCall = function (context, ...args) {
  if (typeof this !== "function") {
    throw new TypeError("only function can call myCall!")
  }
...
Function.prototype.myApply = function (context, arr) {
  if (typeof this !== "function") {
    throw new TypeError("only function can call apply!")
  }
...
Function.prototype.myBind = function (context, ...args) {
  if (typeof this !== "function") {
    throw new TypeError("only function can bind!")
  }
